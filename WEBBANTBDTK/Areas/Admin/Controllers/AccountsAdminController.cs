...
using WEBBANTBDTK.Areas.Admin.Models;
...
namespace WEBBANTBDTK.Areas.Admin.Controllers
{
    ...
    public class AccountsAdminController : Controller
    {
        ...
        public AccountsAdminController(dbWEBTBDTKContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index(string returnUrl = null)
        {
            ...
            var dbWEBTBDTKContext = _context.Accounts.Include(a => a.Role);
            return View(await dbWEBTBDTKContext.ToListAsync());
        }
