...
namespace WEBBANTBDTK.Areas.Admin.Controllers
{
    ...
    public class ProductsAdController : Controller
    {
        ...
        public ProductsAdController(dbWEBTBDTKContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public IActionResult Index(int page = 1, int CatID = 0, string returnUrl = null)
        {
            var pageNumber = page;
            var pageSize = 8;
        ...
        {
            var url = $"/Admin/ProductsAd?CatID={CatID}";
            if (CatID == 0)
            {
                url = $"/Admin/ProductsAd";
            }
