...
namespace WEBBANTBDTK.Areas.Admin.Controllers
{
    ...
    public class CustomersAdController : Controller
    {
        ...
        public CustomersAdController(dbWEBTBDTKContext context)
        {
            _context = context;
        }

        // GET: Admin/AdminCustomers
        public IActionResult Index(int? page, string returnUrl = null)
        {
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,FullName,Birthday,Avatar,Address,Email,Phone,LocationId,District,Ward,CreateDate,Password,Salt,LastLogin,Active")] Customer customer, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
            if (ModelState.IsValid)
            {
                ...
                if (fThumb != null)
                {
                    ...
                    customer.FullName = await Utilities.UploadFile(fThumb, @"products", image.ToLower());
                }
